...
@testset "Tensors" begin
    ...
    @test x_tensor(2, Parameter(Val(:Factor), 1)) ≈ [1 0; 0 1]
    @test x_tensor(2, Parameter(Val(:PiUnit), 0.0)) ≈ [1 0; 0 1]
...
@testset "Convert to Einsum" begin
    ...
    # yao_mtx is generated by following code, will not compute it here
    # since it requires Yao.jl to be installed
