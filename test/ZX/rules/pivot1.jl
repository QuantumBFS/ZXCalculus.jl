...
@testset "Pivot1Rule" begin
    @testset "Basic pivot gadget elimination" begin
        g = Multigraph(14)
    ...
    @testset "Various phase configurations" begin
        # TODO: Test pivot gadget elimination with various phase configurations
    end

    @testset "Edge operations" begin
        # TODO: Test edge addition/removal during pivoting
    end

    @testset "Circuit boundaries" begin
        # TODO: Test interaction with circuit boundaries
    end
end
