struct Identity2Rule <: AbstractRule end

function Base.match(::Identity2Rule, zxd::ZXDiagram{T, P}) where {T, P}
    matches = Match{T}[]
...
function check_rule(r::Identity2Rule, zxd::ZXDiagram{T, P}, vs::Vector{T}) where {T, P}
    @inbounds v1, v2 = vs
...
function rewrite!(r::Identity2Rule, zxd::ZXDiagram{T, P}, vs::Vector{T}) where {T, P}
    @inbounds v1, v2 = vs
